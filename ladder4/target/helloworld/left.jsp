...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            ...
            <li><cite></cite><a href="today" target="rightFrame">今日菜单</a><i></i></li>
                <li><cite></cite><a href="weak" target="rightFrame">本周菜单</a><i></i></li>
                <li><cite></cite><a href="tab.jsp" target="rightFrame">用餐建议</a><i></i></li>
                <li><cite></cite><a href="order" target="rightFrame">订餐</a><i></i></li>
                <li><cite></cite><a href="orderForm.jsp" target="rightFrame">查看订餐信息</a><i></i></li>
                <li><cite></cite><a href="consume.jsp" target="rightFrame">查看消费信息</a><i></i></li>
